...
b="+",q=1):(d+="<b>negative</b>.",b="-",q=-1);l="<h2>"+h+'-bit representation</h2><div class="bits">'+l+"</div><p>"+(d+"</p>");var e="";for(a=1;a<=k;a++)e+=c[a];d="The exponent stored as "+k+' bits <span class="fp-bit fp-exp">'+(e+"</span> = ");e=parseInt(e,2);l+="<p>"+(d+("<b>"+e+"</b> and the real value is "+e+" - "+n+" = <b>"+(e-n)+"</b>. So the exponent is <b>2<sup>"+(e-n)+"</sup></b>.</p>"));d="";var p=0;for(a=k+1;a<h;a++)d+=c[a],p+=c[a]*Math.pow(2,k-a);a={minimumFractionDigits:10,maximumFractionDigits:20};
