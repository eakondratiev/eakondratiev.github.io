...
w=m.getElementsByTagName("b")[0],n=document.getElementById("bytes-counter"),v=n.getElementsByTagName("b")[0],k="undefined"!==typeof TextEncoder,h=document.getElementById("text-character"),p=h.getElementsByTagName("b")[0],q=h.getElementsByTagName("b")[1],r=T.getUrlParameters();k&&(n.style.display="");b.focus();"undefined"!==typeof Event&&"object"===typeof b.oninput?b.addEventListener("input",f):(b.addEventListener("change",f),b.addEventListener("keyup",f),b.addEventListener("paste",function(c){setTimeout(function(){f()},
0)}));void 0!==r.t&&(b.value=decodeURIComponent(r.t),f());void 0!==window.getSelection&&void 0!==String.fromCodePoint&&(h.style.display="block",b.onmouseup=function(){g()},g=function(){var c=b.selectionStart,d=b.value.codePointAt(c);var a=1>=b.selectionEnd-c?d:0;var t="";c=!0;if(0===a)p.innerHTML="",q.innerHTML="";else{d=Array(4);var e;for(e=3;0<=e;e--)d[e]=a>>8*e&255;p.innerHTML=0<a?String.fromCodePoint(a):"";for(a=d.length-1;0<=a;a--)if(0!==d[a]||!c){c=!1;e=d[a];var u=e.toString(16);e=16>e?"0"+
u:u;t+=" "+e}q.innerHTML=t}})};
