...
g),e.addEventListener("paste",function(c){setTimeout(function(){g(c)},0)}));e.addEventListener("keyup",g);void 0!==w.t&&(e.value=decodeURIComponent(w.t),g());void 0!==window.getSelection&&void 0!==String.fromCodePoint&&(m.style.display="block",e.onmouseup=function(){k()},k=function(){var c=e.selectionStart,b=e.value.codePointAt(c);var a=1>=e.selectionEnd-c?b:0;c="";b=0;if(0===a||void 0===a)u.innerHTML="",v.innerHTML="";else{0<a&&(u.innerHTML=String.fromCodePoint(a));var d=Array(4),f;for(f=3;0<=f;f--)d[f]=
a>>8*f&255;for(a=d.length-1;0<=a;a--)if(0===d[a])++b;else break;for(a=d.length-1;0<=a;a--)0===d[a]&&(2<=b&&2<=a||1===b&&3===a)||(c=1>=b&&2===a?c+d[a].toString(16):c+p(d[a]));v.innerHTML="U+"+c}})};
